function varargout = tela_controle_mm_com_angulo(varargin)
% TELA_CONTROLE_MM_COM_ANGULO M-file for tela_controle_mm_com_angulo.fig
%      TELA_CONTROLE_MM_COM_ANGULO, by itself, creates a new TELA_CONTROLE_MM_COM_ANGULO or raises the existing
%      singleton*.
%
%      H = TELA_CONTROLE_MM_COM_ANGULO returns the handle to a new TELA_CONTROLE_MM_COM_ANGULO or the handle to
%      the existing singleton*.
%
%      TELA_CONTROLE_MM_COM_ANGULO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TELA_CONTROLE_MM_COM_ANGULO.M with the given input arguments.
%
%      TELA_CONTROLE_MM_COM_ANGULO('Property','Value',...) creates a new TELA_CONTROLE_MM_COM_ANGULO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before tela_controle_mm_com_angulo_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to tela_controle_mm_com_angulo_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help tela_controle_mm_com_angulo

% Last Modified by GUIDE v2.5 28-Jul-2015 03:53:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @tela_controle_mm_com_angulo_OpeningFcn, ...
                   'gui_OutputFcn',  @tela_controle_mm_com_angulo_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before tela_controle_mm_com_angulo is made visible.
function tela_controle_mm_com_angulo_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to tela_controle_mm_com_angulo (see VARARGIN)

% Choose default command line output for tela_controle_mm_com_angulo
...
% UIWAIT makes tela_controle_mm_com_angulo wait for user response (see UIRESUME)
% uiwait(handles.figure1);



% --- Outputs from this function are returned to the command line.
function varargout = tela_controle_mm_com_angulo_OutputFcn(hObject, eventdata, handles) 
